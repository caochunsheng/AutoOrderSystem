...
namespace AutoOrderSystem.UI
{
    public partial class FrmBase2 : Form
    {
        ...
        private void FrmERPOrder_MouseDown(object sender, MouseEventArgs e)
        {

        }

        private void FrmERPOrder_MouseUp(object sender, MouseEventArgs e)
        {

        }

        private void FrmERPOrder_MouseMove(object sender, MouseEventArgs e)
        {

...
namespace AutoOrderSystem.UI
{
    public partial class FrmMain : Form
    {
        ...
        public FrmMain()
        {
            ...
            this._orderList = new List<ExOrder>();
        }
        ...
        private void UpdateUI(bool logined)
        {
            if (logined)
            {
                this.lbl_ServerIP.ForeColor = Color.Green;
                this.lbl_ServerIP.Text = $"服务器：{_reqSession.host}";
                this.lbl_LoginUser.ForeColor = Color.Green;
                this.lbl_LoginUser.Text = $"登录用户：{_reqSession.user}";
                this.lbl_Status.ForeColor = Color.Green;
                this.lbl_Status.Text = "状态：就绪";
            }
            else
            {
                this.lbl_ServerIP.ForeColor = Color.Red;
                this.lbl_ServerIP.Text = $"服务器：{_reqSession.host}";
                this.lbl_LoginUser.ForeColor = Color.Red;
                this.lbl_LoginUser.Text = $"登录用户：{_reqSession.user}";
                this.lbl_Status.ForeColor = Color.Red;
                this.lbl_Status.Text = "状态：断开";
            }
        }
    }
}
